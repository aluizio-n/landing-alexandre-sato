  ...
  department: [
    {
      ...
      address: {
        "@type": "PostalAddress",
        streetAddress: "Av. Major Gabriel",
    ...
    {
      "@type": "AutoBodyShop",
      name: "Alexandre Sato - Unidade Paraíba",
      address: {
        "@type": "PostalAddress",
        streetAddress: "Av. Paraíba",
        addressLocality: "Manaus",
        addressRegion: "AM",
        addressCountry: "BR",
      },
    ...
    {
      "@type": "AutoBodyShop",
      name: "Alexandre Sato - Unidade Ephigênio Salles",
      address: {
        "@type": "PostalAddress",
        streetAddress: "Avenida Ephigênio Salles",
        addressLocality: "Manaus",
        addressRegion: "AM",
        addressCountry: "BR",
      },
